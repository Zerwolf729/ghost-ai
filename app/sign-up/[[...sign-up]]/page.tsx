...
/**
 * Catch‑all sign‑up page for Clerk.
 * Handles Clerk callbacks while preserving the UI.
 */
export default function SignUpPage() {
  return (
    <main className="min-h-screen flex">
      ...
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2 bg-base text-primary">
